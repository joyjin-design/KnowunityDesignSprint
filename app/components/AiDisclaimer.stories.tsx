...
- Padding is bound directly on the component: \`size.space.100\` (4px) on top, \`size.space.800\` (32px) on bottom, and, since a Figma update on 2026-09-15, \`size.space.300\` (12px) on the left. None on the right.
