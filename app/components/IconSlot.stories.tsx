...
- Checked Storybook first: nothing existing could build this — it's a primitive, not a composition. The reverse is true though, and worth knowing: \`Button\`, \`ButtonIcon\`, \`Chip\`, \`Snackbar\` and \`resultBtm\` each already hand-roll their own icon box from the same \`size.icon.*\` scale (roughly 16 declarations across five stylesheets). This component is what they'd collapse onto. That refactor wasn't part of this build.
